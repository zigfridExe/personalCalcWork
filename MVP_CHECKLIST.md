...
- [ ] Simplificar o fluxo de criação de aula no calendário:
  - [ ] Ao clicar em "Nova Aula", abrir fluxo para escolher aluno.
  - [ ] Permitir seleção do tipo de aula (avulsa/recorrente).
  - [ ] Permitir escolha de dias/horários.
  - [ ] Adicionar campo para observações.

## 5. Ficha de Treino
- [ ] Normalizar o formato de datas e horários em todas as telas e no banco de dados.

## 6. Documentação
- [ ] Documentar no código e em um documento rápido:
  - [ ] As soluções temporárias implementadas.
  - [ ] As limitações conhecidas do MVP. 